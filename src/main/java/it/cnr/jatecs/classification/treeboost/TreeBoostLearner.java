...
public class TreeBoostLearner extends BaseLearner {
    ...
    public TreeBoostLearner(ILearner learner) {
        this(learner, null);
    }

    public TreeBoostLearner(ILearner learner, IOperationStatusListener status) {
        assert (learner != null);
