...
public class SvmLightLearner extends BaseLearner {

    public SvmLightLearner() {
        _customizer = null;
    }
    ...
    public IClassifier build(IIndex trainingIndex) {
        ...
        SvmLightLearnerCustomizer customizer = (SvmLightLearnerCustomizer) _customizer;
        ...
        while (it.hasNext()) {
            ...
            cmdList.add(customizer.getSvmLightLearnPath());

            cmdList.add("-c");
            cmdList.add("" + customizer.getC());

            cmdList.add("-t");
            cmdList.add("" + customizer.getKernelType());

            String[] split = customizer.getAdditionalParameters().split("\b");
            if (split != null) {
        ...
        JatecsLogger.status().println("Ok. All the categories was processed.");
