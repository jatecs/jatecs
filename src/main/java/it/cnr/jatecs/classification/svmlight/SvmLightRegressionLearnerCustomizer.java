...
public class SvmLightRegressionLearnerCustomizer implements ILearnerRuntimeCustomizer {

    /**
     * The path (only directory) where to find the svm_light executables.
     */
    protected String _svm_lightPath;
    ...
    public SvmLightRegressionLearnerCustomizer() {
        super();
        _svm_lightPath = "/home/fagni/Software/bin/";
    ...
    public ILearnerRuntimeCustomizer cloneObject() {
        SvmLightRegressionLearnerCustomizer customizer = new SvmLightRegressionLearnerCustomizer();
        customizer._svm_lightPath = _svm_lightPath;
        return customizer;
    }
