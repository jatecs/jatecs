...
public class ClassifierWithResults extends JatecsModule {
    ...
    public ClassifierWithResults(IIndex testIndex, IClassifier classifier, String classifierDir) {
        this(testIndex, classifier, classifierDir, testIndex.getCategoryDB());
    }

    public ClassifierWithResults(IIndex testIndex, IClassifier classifier, String classifierDir, ICategoryDB validCategories) {
    ...
    protected void classifyPerDocument() {
        ...
        ClassificationComparer cc = new ClassificationComparer(builder.getClassificationDB(), index().getClassificationDB(), new TShortArrayListIterator(_validCategories));
        ...
        try {
            ContingencyTableDataManager.writeContingencyTableSet(fname, tableSet);
        } catch (IOException e) {
            throw new RuntimeException(e);
        }

        String res = EvaluationReport.printReport(tableSet, index().getCategoryDB());
    ...
    protected void processModule() {
        ...
        JatecsLogger.status().println("Time for classification: " + (end - start) + " milliseconds");
    }
