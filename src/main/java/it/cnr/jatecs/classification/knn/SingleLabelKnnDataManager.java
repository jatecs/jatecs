...
public class SingleLabelKnnDataManager implements IDataManager {
    ...
    public IClassifierRuntimeCustomizer readClassifierRuntimeConfiguration(
        ...
        SingleLabelKnnClassifierCustomizer c = new SingleLabelKnnClassifierCustomizer();
    ...
    public void writeClassifierRuntimeConfiguration(String confDir,
        ...
        SingleLabelKnnClassifierCustomizer c = (SingleLabelKnnClassifierCustomizer) customizer;
