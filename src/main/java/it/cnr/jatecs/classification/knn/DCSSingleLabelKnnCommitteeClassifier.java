...
public class DCSSingleLabelKnnCommitteeClassifier extends BaseClassifier {
    ...
    public DCSSingleLabelKnnCommitteeClassifier(IIndex training, ICategoryDB catsDB) {
        _catsDB = catsDB;
