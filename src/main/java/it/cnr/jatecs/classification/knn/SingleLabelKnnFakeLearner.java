...
public class SingleLabelKnnFakeLearner implements ILearner {

    protected SingleLabelKnnClassifier _cl;

    public SingleLabelKnnFakeLearner(SingleLabelKnnClassifier cl) {
        _cl = cl;
    }

    public SingleLabelKnnClassifier getKnnClassifier() {
        return _cl;
    }

    public IClassifier build(IIndex trainingIndex) {
        _cl._training = trainingIndex;
        return _cl;
    }
