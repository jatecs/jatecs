...
public class CRWMVSingleLabelKnnCommitteeClassifier extends BaseClassifier {
    ...
    public CRWMVSingleLabelKnnCommitteeClassifier(IIndex training,
                                                  ICategoryDB catsDB) {
        _catsDB = catsDB;
    ...
    public ClassificationResult classify(IIndex testIndex, int docID) {
        ...
        double[] scores = new double[_training.getCategoryDB()
                .getCategoriesCount()];
