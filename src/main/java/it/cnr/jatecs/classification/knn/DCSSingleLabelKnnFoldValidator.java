...
public class DCSSingleLabelKnnFoldValidator extends BaseLearner {
...
//	}
    ...
    protected DCSSingleLabelKnnCommitteeClassifier _classifier;
    protected float[][] _globalSimMatrix;

    public DCSSingleLabelKnnFoldValidator(
            DCSSingleLabelKnnCommitteeClassifier classifier) {
    ...
    protected OptimalConfiguration optimizeFor(
            DCSSingleLabelKnnCommitteeClassifier classifier, IIndex training,
