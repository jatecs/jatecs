...
public class InMemoryWeakHypothesis implements IWeakHypothesis {

    protected HypothesisData[] _data;

    public InMemoryWeakHypothesis(int size) {
        _data = new HypothesisData[size];
    }
