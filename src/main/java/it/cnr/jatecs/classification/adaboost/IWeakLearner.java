...
public interface IWeakLearner {
    ...
    /**
     * Construct a weak hypothesis beginning from specified distribution matrix and the index.
     *
     * @param matrix The initial distribution matrix.
     * @param index  The source index.
     * @return A weak hypothesis usable in AdaBoost algorithm.
     */
    public IWeakHypothesis getNewWeakHypothesis(IWeighting3DManager matrix, IIndex index);
