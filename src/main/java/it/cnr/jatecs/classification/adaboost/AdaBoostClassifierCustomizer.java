...
public class AdaBoostClassifierCustomizer implements
    ...
    public AdaBoostClassifierCustomizer() {
        this(Integer.MAX_VALUE);
    }

    public AdaBoostClassifierCustomizer(int numIterations) {
    ...
    /**
     * This flag is used by weak learners such as the decision stump to reduce
     * to a single hypothesis the set of hypotheses that use the same feature as
     * the decision stump.
     *
     * @param groupHypothesis
     */
