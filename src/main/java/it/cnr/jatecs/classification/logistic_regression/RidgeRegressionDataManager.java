...
public class RidgeRegressionDataManager implements IDataManager {
    ...
    public void write(String modelDir, IClassifier learningData)
        ...
        RidgeRegressionClassifier c = (RidgeRegressionClassifier) learningData;
    ...
    public IClassifier read(String modelDir) throws IOException {
        ...
        RidgeRegressionClassifier c = new RidgeRegressionClassifier(numCats);
    ...
    public IClassifier read(IStorageManager storageManager, String modelName) {
        ...
        try {
            try {
                ...
                RidgeRegressionClassifier c = new RidgeRegressionClassifier(
                        numCats);
                for (int catID = 0; catID < numCats; catID++) {
                    c.weigths[catID] = new double[numFeatures];
                    for (int i = 0; i < numFeatures; i++) {
