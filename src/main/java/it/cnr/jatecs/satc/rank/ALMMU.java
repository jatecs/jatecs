...
import it.cnr.jatecs.activelearning.MMU;
import it.cnr.jatecs.classification.ClassificationScoreDB;
import it.cnr.jatecs.indexes.DB.interfaces.IIndex;
import it.cnr.jatecs.satc.interfaces.IStaticRank;

public class ALMMU extends MMU implements IStaticRank {

    public ALMMU(ClassificationScoreDB confidenceUnlabelled, IIndex trainingSet) {
