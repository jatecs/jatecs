...
public class WipoAlphaCategoryReader implements ICategoryReader {
     ...
     */
    public WipoAlphaCategoryReader(String categoriesFile,
    ...
    public ICategoryDB getCategoryDB() throws Exception {
        ...
        try {
            ...
            _categoryDBBuilder.setCategories(cats);
            ...
            while (en.hasMoreElements()) {
                ...
                if (!parent.equals("")) {
                    try {
                        _categoryDBBuilder.setParentCategory(categories
                                .get(cat).getFirst(), categories.get(parent)
                                .getFirst());
                    } catch (Exception e) {
                        reader.close();
