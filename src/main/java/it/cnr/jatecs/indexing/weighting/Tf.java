...
public class Tf implements IWeighting {
    ...
    public IIndex computeWeights(IIndex index) {
        ...
        TroveWeightingDBBuilder weighting = new TroveWeightingDBBuilder(index
                .getContentDB());
        ...
        while (it.hasNext()) {
            ...
            while (itFeats.hasNext()) {
                ...
                double weight = index.getContentDB()
        ...
        GenericIndex i = new GenericIndex("Weighted index", index
                .getFeatureDB(), index.getDocumentDB(), index
                .getCategoryDB(), index.getDomainDB(), index.getContentDB(),
                weighting.getWeightingDB(), index.getClassificationDB());
