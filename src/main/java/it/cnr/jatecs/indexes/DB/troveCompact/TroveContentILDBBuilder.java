...
public class TroveContentILDBBuilder implements IContentDBBuilder {

    protected TroveContentILDB _contentDB;

    public TroveContentILDBBuilder(IDocumentDB documentsDB,
                                   IFeatureDB featuresDB) {
        super();
        _contentDB = new TroveContentILDB(documentsDB, featuresDB);
    }

    public TroveContentILDBBuilder(TroveContentILDB contentDB) {
        super();
