...
/**
 * Implements a probability-based Linear Distributional Correspondence Function.
 * @see IDistributionalCorrespondenceFunction
 * */
public class LinearDCF extends ADiscreteDCF {
	
	public LinearDCF(IIndex index) {
		super(index);
	}
	...
	protected double distributionalCorrespondence(DocSet Fd, DocSet Pd) {		
		...
		return (TP*1.0/(TP + FN))+(TN*1.0/(TN+FP))-1;		
	}
}
