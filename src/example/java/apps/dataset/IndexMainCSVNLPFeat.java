...
import it.cnr.jatecs.indexing.corpus.NLPFeatureExtractor;
...
public class IndexMainCSVNLPFeat {
    ...
    public static void main(String[] args) throws IOException {
        ...
        NLPFeatureExtractor extractor = new NLPFeatureExtractor();
        ...
        FullIndexConstructor mainIndexConstructor = new FullIndexConstructor(
                corpusReader, mainIndexBuilder, true);
        ...
        indexName = indexName + "_NLP_" + catName;
