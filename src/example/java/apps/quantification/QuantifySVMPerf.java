...
/**
 * This app applies a pool of SVM_perf-based quantification models to a test set.
 * <p>
 * The SVM_perf classify executable must be locally available.
 *
 * @author Andrea Esuli
 */
public class QuantifySVMPerf {
    ...
    public static void main(String[] args) throws IOException {
        ...
        OptionBuilder
                .withDescription("Don't delete temporary files in svm_perf format (default: delete)");
        ...
        SvmPerfDataManager classifierDataManager = new SvmPerfDataManager(
                customizer);
