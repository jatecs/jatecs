...
public class CleanByKnn {

    public static void main(String[] args) throws IOException {
        if (args.length != 1) {
            System.err.println("Usage: CleanByKnn <indexDirectory>");
            return;
        }
        ...
        KnnClassifier classifier = new KnnClassifier(index);
